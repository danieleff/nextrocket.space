...
<table id="launch_table" class="launch_table">
    <?php
        ...
        echo "<th></th>";
        echo "<th></th>";
        echo "<td valign=\"top\" style=\"white-space: nowrap; text-align: left;overflow: hidden; text-overflow: ellipsis;\">".$filters[0]."</td>";
        echo "<td valign=\"top\" style=\"white-space: nowrap; text-align: left;overflow: hidden; text-overflow: ellipsis;\">".$filters[1]."</td>";
        echo "<td valign=\"top\" style=\"white-space: nowrap; text-align: left;overflow: hidden; text-overflow: ellipsis;\">".$filters[2]."</td>";
        echo "<td valign=\"top\" style=\"white-space: nowrap; text-align: left;overflow: hidden; text-overflow: ellipsis;\">".$filters[3]."</td>";
        echo "<th></th>";
        echo "</tr>";
